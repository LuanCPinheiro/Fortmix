...
@section('title', 'Produtos - Pecuária de Leite - FortMix Nutrição Animal')

@section('seo')
<link rel="canonical" href="www.fortmixnutricao.com.br"/>
<meta name="robots" content="index, follow, max-image-preview:large"/>
<meta name="description" content="Produtos FortMix para Pecuária de Leite - Qualidade e Tradição!">
@endsection

@section('ogcontent')
<meta property="og:url" content="www.fortmixnutricao.com.br/produtosleite">
<meta property="og:title" content="Produtos - Pecuária de Leite - FortMix Nutrição Animal">
<meta property="og:image" content="Produtos FortMix para Pecuária de Leite - Qualidade e Tradição!">
...
@section('produtosleite')
active
@endsection

@section('headerfiles')
<link href="css/ajustesProdutosLeite.css?v=9.4" rel="stylesheet">
@endsection
...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-center mb-3">
        <button id="btnProntoParaUso" class="btn btn-primary me-2">Produtos Prontos para Uso</button>
    </div>
    ...
    <div id="filtrosEstagioAnimal" class="d-flex justify-content-center mb-3">
        <div class="row justify-content-center">
            <div class="col-auto col-md-auto text-center mb-3">
                <button class="btn btn-outline-secondary text-center icon-btn" onclick="filtrarPorEstagio('lactação')">
                    <img src="{{ asset('storage/estagios_animais/lactacao.png') }}" alt="Lactação" class="mb-2 icon-image">
                    <div>Lactação</div>
                </button>
            </div>
            <div class="col-auto col-md-auto text-center mb-3">
                <button class="btn btn-outline-secondary text-center icon-btn" onclick="filtrarPorEstagio('recria')">
                    <img src="{{ asset('storage/estagios_animais/recria.png') }}" alt="Recria" class="mb-2 icon-image">
                    <div>Recria</div>
                </button>
            </div>
            <div class="col-auto col-md-auto text-center mb-3">
                <button class="btn btn-outline-secondary text-center icon-btn" onclick="filtrarPorEstagio('bezerros')">
    ...
    <div id="filtrosAdicionaisLactacao" class="d-none mb-3">
        <div class="d-flex justify-content-center">
            <button class="btn btn-outline-primary me-2 botoesLactacao" onclick="filtrarPorTipoLactacao('semureia')">Sem Ureia</button>
            <button class="btn btn-outline-primary me-2 botoesLactacao" onclick="filtrarPorTipoLactacao('comureia')">Com Ureia</button>
            <button class="btn btn-outline-primary botoesLactacao" onclick="filtrarPorTipoLactacao('minerais')">Minerais e Adensados</button>
        </div>
    </div>

    <div id="filtrosAdicionaisProteinaSem" class="d-none mb-3">
        <div class="d-flex justify-content-center">
            <button class="btn btn-outline-primary me-2 botoesProteina" onclick="filtrarProteina('24sem')">24% de Proteína Bruta</button>
            <button class="btn btn-outline-primary me-2 botoesProteina" onclick="filtrarProteina('22sem')">22% de Proteína Bruta</button>
            <button class="btn btn-outline-primary botoesProteina" onclick="filtrarProteina('18sem')">18% de Proteína Bruta</button>
        </div>
    </div>

    <div id="filtrosAdicionaisProteinaCom" class="d-none mb-3">
        <div class="d-flex justify-content-center">
            <button class="btn btn-outline-primary me-2 botoesProteina" onclick="filtrarProteina('24com')">24% de Proteína Bruta</button>
            <button class="btn btn-outline-primary me-2 botoesProteina" onclick="filtrarProteina('22com')">22% de Proteína Bruta</button>
        </div>
    </div>
    ...
    <div class="listaOrdenadaProdutos mt-6 row g-4 justify-content-center">
        <h2>Lista Completa de Produtos - Pecuária de Leite</h2>
        <ol>
...
@section('endfiles')
<script type="text/javascript" src="js/ajustesProdutosLeite.js?v=6.7"></script>
@endsection