...
@section('titulo', isset($post) ? 'Editar Post' : 'Criar Novo Post')
...
@section('content')
<div class="container">
    <h1>{{ isset($post) ? 'Editar Post' : 'Criar Novo Post' }}</h1>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="produtos[]" value="{{ $produto->id }}" 
                                                       @if(isset($post) && $post->produtos->contains($produto->id)) checked @endif>
